...
def putBorderText(img, text, org, fontFace, fontScale, fg_color, bg_color, thickness, border_thickness=2, lineType=None, bottomLeftOrigin=None):
    cv2.putText(img=img, text=str(text), org=org, fontFace=fontFace, fontScale=fontScale, color=bg_color, thickness=thickness+border_thickness, lineType=lineType, bottomLeftOrigin=bottomLeftOrigin)
    cv2.putText(img=img, text=str(text), org=org, fontFace=fontFace, fontScale=fontScale, color=fg_color, thickness=thickness, lineType=lineType, bottomLeftOrigin=bottomLeftOrigin)
