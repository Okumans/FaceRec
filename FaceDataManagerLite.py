...
class App(QMainWindow):
    def resizeEvent(self, event):
        self.add_button.move(self.size().width() - 80, self.size().height() - 80)
    ...
    def __init__(self, target_directory: str):
        ...
        self.id_information_label.setMinimumSize(QSize(320, 330))
        self.id_information_label.setMaximumSize(QSize(320, 330))
        ...
        self.data_label.setMinimumHeight(240)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 563//2, 540//2))
        ...
        self.save_button.setMaximumSize(QSize(60, 35))
        ...
        self.delete_button.setMaximumSize(QSize(60, 35))
    ...
    def add_input(self, message, data_name, enable=True, value=None):
        ...
        fontl = QFont()
        fontl.setFamily("Kanit")
        fontl.setPointSize(7)
        fontl.setBold(False)
        input_lineedit.setFont(fontl)

        # Set the size policy of the input_lineedit widget to expanding
        input_lineedit.setSizePolicy(QSizePolicy.Preferred, QSizePolicy.Expanding)
