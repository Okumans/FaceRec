...
class Ui_Dialog(QDialog):
    ...
    def __init__(self, parent=None, default_setting=None, image=None):
        ...
        self.imageBox.setGeometry(QtCore.QRect(30, 20, 381, 221))
        ...
        self.buttonBox.setGeometry(QtCore.QRect(240, 390, 171, 32))
        self.buttonBox.setOrientation(QtCore.Qt.Horizontal)
        self.buttonBox.setStandardButtons(QtWidgets.QDialogButtonBox.Cancel | QtWidgets.QDialogButtonBox.Ok)
        self.buttonBox.setObjectName("buttonBox")

        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 260, 221, 232))
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(230, 260, 200, 118))
