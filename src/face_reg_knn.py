...
if __name__ == "__main__":
    ...
    classifier = train(
        r"resources/test3/knn_examples",
    ...
    for image_file in os.listdir("resources/test3/test"):
        full_file_path = os.path.join("resources/test3/test", image_file).lower()
        ...
        show_prediction_labels_on_image(os.path.join("resources/test3/test", image_file).lower(), predictions)
